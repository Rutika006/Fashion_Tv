  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 w-full z-50 flex justify-between items-center p-4  ${
        scrolled
          ...
          : "bg-blue-600 shadow-md bg-transparent backdrop-blur-md border-b border-white/10"
    ...
    >
      ...
      <ul className="hidden md:flex space-x-6 text-sm md:text-base lg:text-lg">
        <motion.li whileHover={{ scale: 1.1, color: "#FFD1DC" }} className="cursor-pointer">
          Home
        </motion.li>
        <motion.li whileHover={{ scale: 1.1, color: "#FFD1DC" }} className="cursor-pointer">
          About
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            <motion.li whileHover={{ scale: 1.1, color: "white" }} className="cursor-pointer">
              Home
            </motion.li>
            <motion.li whileHover={{ scale: 1.1, color: "white" }} className="cursor-pointer">
              About
